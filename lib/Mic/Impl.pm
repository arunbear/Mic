...
An implementation is a package containing subroutines implementing the
behaviours described by the class interface as well as attribute definitions (object state).
